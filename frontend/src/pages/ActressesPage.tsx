...
export default function ActressesPage() {
    ...
    return (
        <div>
            <h1 className="text-3xl font-bold mb-8">Actresses</h1>
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                {data.map((actress) => (
                    ...
                    >
                        ...
                        <h3 className="font-semibold text-sm line-clamp-2">{actress.name}</h3>
                        <p className="text-xs text-gray-400">{actress.video_count} videos</p>
                    </Link>
                ))}
            </div>
        </div>
