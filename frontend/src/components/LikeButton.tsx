    ...
    >
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        @keyframes float-up-1 {
          0% { opacity: 0; transform: translate(-50%, 50%) translateY(0) translateX(0) scale(0) rotate(0deg); }
          10% { opacity: 1; transform: translate(-50%, 50%) translateY(-5px) translateX(-2px) scale(1) rotate(-5deg); }
          100% { opacity: 0; transform: translate(-50%, 50%) translateY(-80px) translateX(-20px) scale(0.3) rotate(-15deg); }
        }

        @keyframes float-up-2 {
          0% { opacity: 0; transform: translate(-50%, 50%) translateY(0) translateX(0) scale(0) rotate(0deg); }
          10% { opacity: 1; transform: translate(-50%, 50%) translateY(-5px) translateX(3px) scale(1) rotate(5deg); }
          100% { opacity: 0; transform: translate(-50%, 50%) translateY(-90px) translateX(25px) scale(0.3) rotate(20deg); }
        }

        @keyframes float-up-3 {
          0% { opacity: 0; transform: translate(-50%, 50%) translateY(0) translateX(0) scale(0) rotate(0deg); }
          10% { opacity: 1; transform: translate(-50%, 50%) translateY(-5px) translateX(0) scale(1) rotate(0deg); }
          100% { opacity: 0; transform: translate(-50%, 50%) translateY(-100px) translateX(0) scale(0.3) rotate(0deg); }
        }

        @keyframes float-up-4 {
          0% { opacity: 0; transform: translate(-50%, 50%) translateY(0) translateX(0) scale(0) rotate(0deg); }
          10% { opacity: 1; transform: translate(-50%, 50%) translateY(-5px) translateX(-4px) scale(1) rotate(-8deg); }
          100% { opacity: 0; transform: translate(-50%, 50%) translateY(-85px) translateX(-30px) scale(0.3) rotate(-25deg); }
        }

        @keyframes float-up-5 {
          0% { opacity: 0; transform: translate(-50%, 50%) translateY(0) translateX(0) scale(0) rotate(0deg); }
          10% { opacity: 1; transform: translate(-50%, 50%) translateY(-5px) translateX(5px) scale(1) rotate(10deg); }
          100% { opacity: 0; transform: translate(-50%, 50%) translateY(-95px) translateX(35px) scale(0.3) rotate(30deg); }
        }

        @keyframes float-up-6 {
          0% { opacity: 0; transform: translate(-50%, 50%) translateY(0) translateX(0) scale(0) rotate(0deg); }
          10% { opacity: 1; transform: translate(-50%, 50%) translateY(-5px) translateX(-6px) scale(1) rotate(-12deg); }
          100% { opacity: 0; transform: translate(-50%, 50%) translateY(-75px) translateX(-40px) scale(0.3) rotate(-35deg); }
        }

        @keyframes float-up-7 {
          0% { opacity: 0; transform: translate(-50%, 50%) translateY(0) translateX(0) scale(0) rotate(0deg); }
          10% { opacity: 1; transform: translate(-50%, 50%) translateY(-5px) translateX(7px) scale(1) rotate(15deg); }
          100% { opacity: 0; transform: translate(-50%, 50%) translateY(-88px) translateX(45px) scale(0.3) rotate(40deg); }
        }
      `}} />
    </div>
  );
